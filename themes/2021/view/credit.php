                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label" for="name">Ad :</label>
                                <div class="col-md-10">
                                    <input class="form-control" id="name" type="text" name="name" placeholder="Adınız" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label" for="surname">Soyad :</label>
                                <div class="col-md-10">
                                    <input class="form-control" id="surname" type="text" name="surname" placeholder="Soyadınız" required>
                                </div>
                            </div>
