...
<?php if(isset($_SESSION['login'])):?>
    <div class="profile-info">
        <div class="container">
            <img src="<?=avatar($readUser['username'], '300')?>" class="profile-img-mini" alt="" style="">
            <a href="/oyuncu/<?=$readUser['username']?>" class="mt-6 text-white font-semibold text-xl text-center block theme-subtitle" style="">  <?=$readUser['username']?> (<?=$readUser["credit"];?> Kredi)</a>

        </div>
        <div class="button-group">
        <a href="/kredi/yukle" class="btn-depozit mt-6 text-white font-semibold text-xl text-center block" style="">Kredi Yükle</a>
        <a href="/cikis-yap" class="mt-6 text-white font-semibold text-xl text-center block btn-logout" style=""> Çıkış yap</a>
        </div>
