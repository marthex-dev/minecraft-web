    ...
    <footer class="page-footer font-small">
        ...
        <?php endif; ?>
        <div class="container footr-bottom py-3">
            <div class="row">
                <div class="col-md-12 col-12 text-center text-md-center">
                    Tüm hakları saklıdır &copy; <script>document.write(new Date().getFullYear())</script><br />
                   
                    <a href="https://rabiweb.com.tr" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Yazılım: RabiWeb" class="justify-content-center">RabiWeb is not affiliated with Mojang AB.</a>
                </div>
            </div>
        </div>
    </footer>
<?php if ($readSettings['preloader']==1): ?>
    ...
    <div id="preload">
        <div id="preload-content">
            <img class="preload-logo" src="<?=$find_read_page.$readSettings['serverLogo']?>" alt="">
