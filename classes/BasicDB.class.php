...
class basicdb extends \PDO
{
    ...
    public function __construct($host, $dbname, $username, $password, $port = '3306', $charset = 'utf8')
    {
        try {
    ...
    private function errorTemplate($errorMsg, $title = null)
    {
        ...
        $responsedb = '<div class="alert alert-top alert-danger d-flex align-items-center"><i class="fe fe-alert-triangle mr-2"></i><p class="mb-0">Veritabanı Hatası: '. $errorMsg .' </p></div>';
