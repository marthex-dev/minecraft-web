...
class upload {
    ...
    function init() {
        ...
        $this->allowed = array(
            ...
            'application/vnd.Rabiweb.opendocument.chart',
            'application/vnd.Rabiweb.opendocument.database',
            'application/vnd.Rabiweb.opendocument.formula',
            'application/vnd.Rabiweb.opendocument.graphics',
            'application/vnd.Rabiweb.opendocument.graphics-template',
            'application/vnd.Rabiweb.opendocument.image',
            'application/vnd.Rabiweb.opendocument.presentation',
            'application/vnd.Rabiweb.opendocument.presentation-template',
            'application/vnd.Rabiweb.opendocument.spreadsheet',
            'application/vnd.Rabiweb.opendocument.spreadsheet-template',
            'application/vnd.Rabiweb.opendocument.text',
            'application/vnd.Rabiweb.opendocument.text-master',
            'application/vnd.Rabiweb.opendocument.text-template',
            'application/vnd.Rabiweb.opendocument.text-web',
        ...
        $this->mime_types = array(
            ...
            'odt' => 'application/vnd.Rabiweb.opendocument.text',
            'ott' => 'application/vnd.Rabiweb.opendocument.text-template',
            'oth' => 'application/vnd.Rabiweb.opendocument.text-web',
            'odm' => 'application/vnd.Rabiweb.opendocument.text-master',
            'odg' => 'application/vnd.Rabiweb.opendocument.graphics',
            'otg' => 'application/vnd.Rabiweb.opendocument.graphics-template',
            'odp' => 'application/vnd.Rabiweb.opendocument.presentation',
            'otp' => 'application/vnd.Rabiweb.opendocument.presentation-template',
            'ods' => 'application/vnd.Rabiweb.opendocument.spreadsheet',
            'ots' => 'application/vnd.Rabiweb.opendocument.spreadsheet-template',
            'odc' => 'application/vnd.Rabiweb.opendocument.chart',
            'odf' => 'application/vnd.Rabiweb.opendocument.formula',
            'odb' => 'application/vnd.Rabiweb.opendocument.database',
            'odi' => 'application/vnd.Rabiweb.opendocument.image',
